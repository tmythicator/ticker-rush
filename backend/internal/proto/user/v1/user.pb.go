...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\raverage_price\x18\x03 \x01(\x01R\faveragePrice\"\xc4\x03\n" +
	"\x04User\x12\x0e\n" +
	...
	"\tportfolio\x18\v \x03(\v2\x1c.user.v1.User.PortfolioEntryR\tportfolio\x1aT\n" +
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	11, // 1: user.v1.User.portfolio:type_name -> user.v1.User.PortfolioEntry
	...
	1,  // 6: user.v1.GetPublicProfileResponse.user:type_name -> user.v1.User
	0,  // 7: user.v1.User.PortfolioEntry.value:type_name -> user.v1.PortfolioItem
