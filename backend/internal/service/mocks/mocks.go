...
func (m *MockUserRepository) GetUserByEmail(ctx context.Context, email string) (*pb.User, string, error) {
...
func (m *MockUserRepository) CreateUser(ctx context.Context, email string, hashedPassword string, firstName string, lastName string, balance float64) (*pb.User, error) {
...
func (m *MockPortfolioRepository) GetPortfolio(ctx context.Context, userID int64) ([]*pb.PortfolioItem, error) {
	args := m.Called(ctx, userID)
	return args.Get(0).([]*pb.PortfolioItem), args.Error(1)
}

func (m *MockPortfolioRepository) GetPortfolioItem(ctx context.Context, userID int64, symbol string) (*pb.PortfolioItem, error) {
	args := m.Called(ctx, userID, symbol)
	return args.Get(0).(*pb.PortfolioItem), args.Error(1)
}

func (m *MockPortfolioRepository) GetPortfolioItemForUpdate(ctx context.Context, userID int64, symbol string) (*pb.PortfolioItem, error) {
	args := m.Called(ctx, userID, symbol)
	return args.Get(0).(*pb.PortfolioItem), args.Error(1)
}

func (m *MockPortfolioRepository) SetPortfolioItem(ctx context.Context, userID int64, symbol string, quantity float64, averagePrice float64) error {
	args := m.Called(ctx, userID, symbol, quantity, averagePrice)
	return args.Error(0)
}

func (m *MockPortfolioRepository) DeletePortfolioItem(ctx context.Context, userID int64, symbol string) error {
	args := m.Called(ctx, userID, symbol)
	return args.Error(0)
}
