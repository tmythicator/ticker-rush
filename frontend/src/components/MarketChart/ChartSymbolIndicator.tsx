...
export const ChartSymbolIndicator = ({ price, priceColor, isLoading, isError }: ChartSymbolIndicatorProps) => {
    return (<div className="px-2 flex flex-col items-end min-w-[80px]">
        {isLoading ? (
