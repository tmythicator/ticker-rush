      ...
      <div className="flex items-center gap-4 text-sm font-medium">
        {isAuthenticated && user ? (
          <>
            ...
            <div
              className="w-9 h-9 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full border-2 border-white shadow-sm flex items-center justify-center text-white font-bold text-xs cursor-default"
              title={user.email}
            >
