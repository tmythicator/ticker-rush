...
export const TradeButton = ({ type, onClick }: TradeButtonProps) => {
    ...
    return (
        <button
            onClick={onClick}
            className={`w-full font-bold py-3 rounded-lg transition-all shadow-sm active:scale-95 transform duration-100 flex items-center justify-center gap-2 ${isBuy
